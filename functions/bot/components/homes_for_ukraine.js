...
exports.homes_for_ukraine = (bot) => {
  ...
  bot.action("start_application", async (ctx) => {
    await ctx.replyWithHTML(
      ...
      7 грудня 2023 року <a href="https://www.gov.uk/guidance/using-the-uk-immigration-id-check-app-for-ukraine-nationals">на урядовому веб-сайті було оновлено></a> інформацію про те, як підтвердити свою особу під час подання заяви на отримання візи 
      Використання додатку ID Check для подачі заявки на отримання візи за програмою "Homes for Ukraine " було <b>призупинено</b>, так само як і можливість подавати біометричні дані по прибуттю до Великої Британії для власників закордонних паспортів з продовженим терміном дії.

      Відтепер, щоб заповнити заявку на участь у програмі "Homes for Ukraine", вам необхідно <b>відвідати візовий центр за межами Великої Британії</b>, де вас сфотографують та знімуть відбитки пальців.`,
      Markup.inlineKeyboard([
