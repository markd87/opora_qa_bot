...
exports.homes_for_ukraine = (bot) => {
  ...
  bot.hears("Дійсний український біометричний паспорт", async (ctx) => {
    ...
    await ctx.replyWithHTML(
      `7 грудня 2023 року на урядовому веб-сайті було оновлено інформацію щодо підтвердження особи під час подання заяви на отримання візи за Ukraine Scheme: https://www.gov.uk/guidance/using-the-uk-immigration-id-check-app-for-ukraine-nationals.

      Використання додатку ID Check для подачі заявок на програми Homes for Ukraine тa Ukraine Family Scheme зупинено, так само як і можливість подавати біометричні дані після прибуття до Великої Британії для власників продовжених паспортів.

      Відтепер, щоб заповнити заявку на отримання візи за програмою Homes for Ukraine або Ukraine Family Scheme, вам необхідно відвідати візовий центр за межами Великої Британії, де вас сфотографують/знімуть відбитки пальців (тобто у будь-якій іншій країні, де є візовий центр UK).

      Детально про процес подачі документів у візовому центрі читайте за посиланням: https://t.me/oporaukchat/95207.`,
      Markup.inlineKeyboard([
  ...
  bot.action("start_application", async (ctx) => {
    await ctx.replyWithHTML(
      ...
      \Зайдіть на урядовий сайт https://www.gov.uk/guidance/apply-for-a-visa-under-the-ukraine-sponsorship-scheme, щоб створити обліковий запис UKVI і почати подавати заявку.

      Кожен повинен подати окрему заяву, навіть діти, які подорожують з членом сім'ї.

      УВАГА!

      <b>1.</b> 7 грудня 2023 року <a href="https://www.gov.uk/guidance/using-the-uk-immigration-id-check-app-for-ukraine-nationals">на урядовому веб-сайті було оновлено</a> інформацію про те, як підтвердити свою особу під час подання заяви на візу. 
      - Використання додатку ID Check для подачі заявки на Homes for Ukraine було <b>зупинено</b>, так само як і можливість здати біометричні дані по прибуттю до Великої Британії для власників закордонних паспортів з продовженим терміном дії. 
      - Відтепер, для того, щоб заповнити заявку на Homes for Ukraine, вам необхідно <b>відвідати візовий центр за межами Великої Британії</b>, де вас сфотографують/знімуть відбитки пальців
      
      <b>2.</b> Починаючи з 19.04.2024, нові візи за програмою Homes for Ukraine видаватимуться на <b>18 місяців</b>. Крім того, особи, які перебувають у Великобританії на підставі тимчасових віз (включаючи Ukraine Scheme), більше не матимуть права виступати в якості спонсорів по програмі Homes for Ukraine. Будь ласка, перейдіть за посиланням для отримання більш детальної інформації: https://www.gov.uk/guidance/apply-for-a-visa-under-the-ukraine-sponsorship-scheme.uk`,
      Markup.inlineKeyboard([
        [Markup.button.callback("Продовжити", "prepare_information")],
        [
          Markup.button.callback(
            "Я подав заявку до 7 грудня 2023 року і досі чекаю на рішення",
            "applied_before_7"
          ),
        ],
      ])
  ...
  bot.action("applied_before_7", async (ctx) => {
    await ctx.replyWithHTML(
      `<b>Якщо ви вже подали заяву на отримання візи за Програмою "Україна", що робити далі?</b>
      \nЩо станеться зі "старою" заявкою Homes for Ukraine або Ukraine Family Scheme (створеною до 7 грудня 2023), залежить від того, чи ви її <b>завершили</b>.

      1. Якщо заявка вже ПОДАНА (докази завантажені і в розділі "Provide evidence" стоїть статус "COMPLETED"), то вона повинна оброблятися за старою процедурою. У цьому випадку ви можете не звертати уваги на повідомлення <b>"Important information about this application"</b> в онлайн-кабінеті.  
      
      2. Якщо заява НЕ була подана, тобто ви її заповнили, але не завантажили/надали докази, вона залишається "чернеткою" і НЕ обробляється. Вам потрібно буде подати НОВУ заяву і здати біометричні дані згідно з новими правилами у візовому центрі за межами Великобританії. Слідкуйте за електронною поштою, з якої ви подавали заяву на візу, ви можете отримати повідомлення про те, що ваша чернетка заяви була видалена.
      
      3. Якщо у вас вже є РІШЕННЯ про видачу візи Ukraine Scheme, тобто справжній лист про дозвіл на поїздку або візова віньєтка, вони залишаються дійсними і дають право на перший в'їзд до Великої Британії та отримання BRP за старою процедурою.

      Якщо у вас виникнуть додаткові запитання, будь ласка, телефонуйте на гарячу лінію +44 808 164 8810`,
      Markup.inlineKeyboard([
        [Markup.button.callback("Гаразд, це все.", "OK")],
        [
          Markup.button.callback(
  ...
  bot.action("prepare_sponsor_information", async (ctx) => {
    await ctx.replyWithHTML(
      ...
      \n1. Скан паспорта (перша сторінка у форматі PDF), скан BRP або іншого документа, що підтверджує британське громадянство або право постійного місця проживання у Великій Британії
      2. Що найкраще описує вашого спонсора? Наприклад, громадянин Великої Британії або статус settled/ILR
