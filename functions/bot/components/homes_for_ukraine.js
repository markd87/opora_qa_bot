...
exports.homes_for_ukraine = (bot) => {
  ...
  bot.action("upload_evidence", async (ctx) => {
    const keyboard = Markup.keyboard([
      [
        "Надав документи, що посвідчують особу заявника, використовуючи додатки TLS або VFS використовуючи додатки TLS або VFS використовуючи додатки TLS або VFS",
      ],
