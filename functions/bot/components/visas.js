...
exports.visas = (bot) => {
  ...
  bot.action("extension_scheme", async (ctx) => {
    ...
    - ви мали дозвіл на перебування у Великій Британії з 18 березня 2022 року по 16 листопада 2023 року або між ними - дозвіл не обов'язково повинен охоплювати весь період
    ...
    НЕ подавайте заяву по Ukraine Extension Scheme, якщо ви хочете продовжити свою існуючу візу Ukraine Scheme - вона не може бути використана для продовження віз, вже виданих за програмою "Ukraine Family Scheme" або "Homes for Ukraine". Зачекайте на нову Ukraine Permission Extension, яка відкриється у 2025 році.`,
      Markup.inlineKeyboard([
