...
exports.faq = (bot) => {
  const faq_1 = Markup.keyboard([
    ["Чи можу я продовжити свою Ukraine Scheme візу?"],
    [
  ...
  //  answers
  bot.hears("Чи можу я продовжити свою Ukraine Scheme візу?", async (ctx) => {
    await ctx.replyWithHTML(
      `Якщо ви отримали дозвіл на перебування у Великій Британії за однією з українських програмHomes for Ukraine, Ukraine Family Scheme, Ukraine Extension Scheme), ви можете подати заяву на отримання візи на наступні 18 місяців, щоб продовжити своє перебування у Великій Британії за програмою *Ukraine Permission Extension*. 

        Ви зможете подати заяву за 3 місяці до закінчення терміну дії вашої існуючої візи. Уряд Великої Британії незабаром надасть додаткову інформацію про нову схему.
        
        НЕ подавайте заяву на продовження візи за програмою Ukraine Extension Scheme, вона не може бути використана для продовження віз, вже виданих за програмою Ukraine Family Scheme або Homes for Ukraine. Зачекайте на нову схему Ukraine Permission Extension, яка почне діяти у 2025 році.`,
      answer_keyboard
    );
  });
  ...
  bot.hears(
    ...
    async (ctx) => {
      await ctx.replyWithHTML(
        ...
        Термін дії паперової віньєтки обмежений 90 днями з дати затвердження візи.`,
        answer_keyboard
      );
    }
  );
  ...
  bot.hears(
    ...
    async (ctx) => {
      await ctx.replyWithHTML(
        `Так, якщо ви є громадянином Великої Британії або Ірландії, або маєте право на постійне проживання у Великій Британії, і можете надати житло щонайменше на 6 місяців

        ПРИМІТКА
        - Якщо ви відповідаєте критеріям, але не проживаєте у Великобританії, ви не можете бути спонсором.
        - З 19 лютого 2024 року люди, які мають тимчасові візи або статуси у Великій Британії, такі як робоча віза, віза Ukraine Scheme або pre-settledстатус - НЕ можуть виступати в якості спонсорів.`,
        answer_keyboard
      );
    }
  );
