...
exports.visa_problems = (bot) => {
  ...
  bot.action("what_decision_look", async (ctx) => {
    ...
    const keyboard = [
      [
        {
          text: "Я не отримав цього листа.",
          callback_data: "problem_visa_delayed",
        },
      ],
      [{ text: "Гаразд, це все.", callback_data: "OK" }],
      [
        {
          text: "У мене є ще одне питання, пов'язане з візою.",
          callback_data: "visas",
        },
      ],
    ];
  ...
  bot.action("homes_for_ukraine_refused", async (ctx) => {
    await ctx.replyWithHTML(
      ...
      \nЩоб зрозуміти причину відмови у видачі візи, уважно перегляньте розділ "Причини відмови" в їхньому електронному листі "Application Update". 

      Найпоширенішими причинами є
      1. <b>Спонсор не має права на отримання візи</b>. Це стосується ситуацій, коли спонсор має відповідний імміграційний статус, але ви не надали його підтвердження (його британський паспорт або BRP), коли завантажували докази для вашої заяви.
      2. <b>Заявник не відповідає вимогам</b>. Щоб подати заявку на участь у Спонсорській програмі для України, ви повинні бути громадянином України або найближчим членом сім'ї громадянина України, який отримав візу в рамках програми "Homes for Ukraine", або подає заявку на участь у програмі і має право на участь у ній. Ви також повинні довести, що ви проживали в Україні на 1 січня 2022 року або безпосередньо перед цією датою (включаючи тих, хто вже виїхав з України) і перебуваєте за межами Великої Британії. Якщо ви не змогли надати докази цього, ваша заявка, швидше за все, буде відхилена.
      ...
      Якщо вам потрібна допомога, звертайтеся до Служби віз та імміграції Великої Британії: +44 808 164 8810 `,
      Markup.inlineKeyboard([
        [Markup.button.callback("Гаразд, це все.", "OK")],
        [
          Markup.button.callback(
